...
public class WesServerSpringConfig implements WebMvcConfigurer {
    ...
    /**
     * Get new request handler facilitating the retrieval of run outputs
     * @return run output retrieval request handler
     */

    @Bean
    @RequestScope
    public GetRunOutputRequestHandler getRunOutputRequestHandler() {
        return new GetRunOutputRequestHandler();
    }

        /**
     * Get new request handler facilitating streaming of run outputs
     * @return run output retrieval request handler
     */

     @Bean
     @RequestScope
     public GetOutputStreamRequestHandler getOutputStreamRequestHandler() {
         return new GetOutputStreamRequestHandler();
     }


    /**
     * Testing with filestreamhandlers
     * @return file streming
     */
    @Bean
    @RequestScope
